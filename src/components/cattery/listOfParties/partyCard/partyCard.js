...
class PartyCard extends Component {
	...
	componentDidMount() {
		this.setState({
			...
			isPresent          : this.props.party.isReservation ? false : true
		});
	...
	render() {
		...
		return (
			<div
				...
				className={`party-wrapper ${isUpcomingReservation && !this.state.isPresent ? 'reservation' : ''}`}
			>
				...
				<div className="time-remaining-cta-container">
					...
					<div className="cta-container">
						...
						>
							...
							<div style={{ width: this.state.width }} className="fill" />
						</button>
					</div>
				</div>
			</div>
